# Token Footprint Methodology

This document records how Token Footprint estimates the environmental impact of
...
| `ENGINEERING_PRIOR` | A Token Footprint assumption for a model nobody has measured |
...
```
   ...
   These are Token Footprint's own fits to the three published scenarios, not
...
Token Footprint produces **estimates** to build intuition and encourage efficient

...
Token Footprint estimates the environmental impact (energy, water, CO₂) of your AI
...
Token Footprint adds a small overlay to ChatGPT and Claude that estimates the
...
limitations. Token Footprint gives estimates to build intuition, not audited
measurements.
...
- **Website content (user-typed text)** — the draft you are typing is sent to a
  ...
  generate the suggestion and is not stored by Token Footprint. Prompt/reply text is

// Token Footprint Content Script
...
(function() {
  ...
  function log(...args) {
    if (config.debug) console.log('[Token Footprint]', ...args);
  }
  ...
  function injectFloatingOverlay() {
    ...
    container.innerHTML = `
      <div class="pf-floating-pill" role="button" tabindex="0" aria-label="Open Token Footprint session details">
    ...
    modal.innerHTML = `
      <div class="pf-modal-container">
        ...
        <div class="pf-modal-header">
          <span class="pf-modal-title">Token Footprint</span>

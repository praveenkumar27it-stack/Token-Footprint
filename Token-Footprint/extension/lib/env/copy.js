// Token Footprint Required Disclosure Copy
// ---------------------------------------------------------------------------
...
(function (root) {
  ...
  const ROUTING_AUTO = 'The app may route this request dynamically. Token Footprint can see the selected mode but not always the backend model.';
  ...
  const UNKNOWN_MODEL = 'Unknown model — Token Footprint will not guess a flagship. Showing a provider-level range instead.';
  ...
  const EVIDENCE_EXPLANATION = {
    ...
    ENGINEERING_PRIOR: 'A Token Footprint assumption for a current model that nobody has measured. Not a measurement.',
  };

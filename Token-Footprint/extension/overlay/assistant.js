// Token Footprint — in-page writing assistant.
// ---------------------------------------------------------------------------
...
(function (root) {
  ...
  const ICONS = {
    // The Token Footprint mark: a leaf built from a single stroke.
  ...
  const MARKUP = `
    <div class="shell" part="shell">
      <div class="bar" id="bar" role="button" tabindex="0" aria-expanded="false"
           aria-label="Token Footprint prompt assistant">
  ...
  function createAssistant(deps) {
    ...
    function renderBar(state) {
      ...
      el.bar.setAttribute('aria-label', `Token Footprint: ${el.headline.textContent}`);
    }

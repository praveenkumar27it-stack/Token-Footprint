# Token Footprint Gemini Proxy

A tiny Cloudflare Worker that powers Token Footprint's optional **AI** tiers
(Gemini Flash):
...
```
https://tokenfootprint-proxy.<your-subdomain>.workers.dev
```
...
```js
const PF_PROXY_URL = 'https://tokenfootprint-proxy.<your-subdomain>.workers.dev';
```

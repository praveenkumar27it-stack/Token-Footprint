...
import {
  Droplets, Zap, BarChart3, Leaf, GraduationCap, Scissors,
...
import { Privacy, Terms, Support, Contact, Confirmed, Install } from './marketing/Pages'
        ...
        <div className="nav-inner">
          <NavLink to={home} end className="nav-brand">
            ...
            <span className="nav-wordmark">
              <span className="nav-title">Token Footprint</span>
      ...
      {demo && (
        <div className="demo-banner">
          <span className="demo-banner-inner">
            ...
            <span>
              Showing <strong>sample data</strong>. Install the Token Footprint extension

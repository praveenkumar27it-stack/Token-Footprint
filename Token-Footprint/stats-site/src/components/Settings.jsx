    ...
    <div className="settings-page">
      ...
      {!extension && (
        <div className="settings-note">
          You're viewing the public demo. Open this page from the Token Footprint
      ...
      <section className="settings-section">
        ...
        <p className="settings-desc">
          Token Footprint checks your writing on-device by default — spelling,
        ...
        <p className="settings-help">
          ...
          If the service is unavailable or rate-limited, Token Footprint silently
      ...
      <section className="settings-section">
        ...
        <ul className="settings-keys">
          <li><kbd>Alt</kbd> + <kbd>P</kbd> — open / close the main Token Footprint panel</li>
      ...
      <section className="settings-section">
        ...
        <div className="settings-privacy">
          <p><strong>Local-first by design.</strong> Token Footprint estimates the
          ...
          <p><strong>When text leaves the device:</strong> only if you turn on
            ...
            Token Footprint. If cloud analysis is off, or the Worker is missing,

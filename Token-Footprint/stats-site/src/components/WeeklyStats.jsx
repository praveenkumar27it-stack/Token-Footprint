...
function EmptyState() {
  return (
    <div className="pf-state">
      ...
      <p>
        Open ChatGPT or Claude with the Token Footprint extension running. The moment
        ...
        <div className="mission-inner">
          <div className="mission-text">
            ...
            <p className="mission-body">
              ...
              seem small, but over time, those prompts add up. Token Footprint estimates the energy,

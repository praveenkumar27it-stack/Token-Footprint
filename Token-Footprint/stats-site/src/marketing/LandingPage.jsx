...
import { SiteNav, SiteFooter, ChromeCTA } from './MarketingChrome'
...
const STEPS = [
  ...
  },
  {
    ...
    body: 'Open ChatGPT or Claude. Token Footprint counts tokens from your messages and estimates the footprint in the background.',
      ...
      <section className="mk-hero" ref={heroRef}>
        ...
        <Motion.div className="mk-hero-inner" style={{ opacity: heroFade }}>
          ...
          >
            ...
            <p className="mk-lede">
              Token Footprint estimates the environmental cost of your AI chats: live,
            ...
            <ul className="mk-hero-trust">
              ...
              <li><Check size={15} /> Free to use</li>
            </ul>
        ...
        <div className="mk-section-inner">
          <Reveal className="mk-section-head">
            ...
            <p className="mk-section-sub">
              This is the real Token Footprint dashboard, the same one that opens from
          ...
          <Reveal delay={0.05}>
            <div className="mk-demo">
              ...
              <div className="mk-demo-frame">
                <iframe
                  title="Token Footprint dashboard live demo"
                  src={demoUrl()}
                  loading="lazy"
                />
              </div>
      ...
      <section className="mk-section mk-section-alt" id="privacy">
        <div className="mk-section-inner mk-trust">
          <Reveal className="mk-trust-copy">
            ...
            <p>
              Token Footprint was built local-first on purpose. The text of your prompts
          ...
          <Reveal delay={0.08} className="mk-trust-aside">
            <div className="mk-quote-card">
              ...
              <p className="mk-quote-src">From the Token Footprint Privacy Policy</p>
            </div>
          </Reveal>
        </div>
      </section>

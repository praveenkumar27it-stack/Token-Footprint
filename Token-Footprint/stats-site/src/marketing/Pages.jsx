...
import { Mail, ShieldCheck, ArrowLeft, LifeBuoy, CheckCircle2, Copy, Check } from 'lucide-react'
  ...
  return (
    <MarketingPage>
      ...
      <section className="mk-doc-body">
        <h2>What Token Footprint does with data</h2>
        <p>
  ...
  return (
    <MarketingPage>
      <DocHeader kicker="Trust" title="Terms of Use" updated="2026-07-01">
        <p className="mk-doc-intro">
          Short and plain, on purpose. By installing or using Token Footprint, you agree
          to the following.
        </p>
      </DocHeader>

      <section className="mk-doc-body">
        <h2>1. What Token Footprint is</h2>
        <p>
        ...
        <p>
          You can use Token Footprint without an account. If you create one, provide a
        ...
        <h2>4. No warranty</h2>
        <p>
          Token Footprint is provided “as is.” It’s a tool for awareness, not a
        ...
        <p>
          To the extent allowed by law, Token Footprint isn’t liable for indirect,
        ...
        <p>
          ...
          when we do. Continuing to use Token Footprint after a change means you accept
          the updated terms.
        </p>
...
const FAQ = [
  {
    q: 'Is Token Footprint free?',
    a: 'Yes. The extension is free. There’s no paid tier.',
  },
  {
  ...
  return (
    <MarketingPage>
      <div className="mk-confirmed">
        ...
        <p className="mk-doc-intro">
          Your account is ready. Open the Token Footprint extension and log in with the
...
// ── Install (local) ───────────────────────────────────────────────────────
// Chrome won't let a web page install an extension or open chrome:// URLs, so
// this lists the steps and offers copy buttons for the two things to paste.
/* global __EXTENSION_DIR__ */
const EXTENSION_DIR = __EXTENSION_DIR__
...
function CopyField({ value }) {
  ...
  return (
    <span className="mk-copy-field">
      <code>{value}</code>
      <button type="button" className="btn btn-ghost btn-sm" onClick={copy} aria-label={`Copy ${value}`}>
...
export function Install() {
  return (
    <MarketingPage>
      <DocHeader kicker="Install" title="Add Token Footprint to Chrome">
        <p className="mk-doc-intro">
          The extension runs straight from this folder on your computer. Loading it
          takes about thirty seconds.
        </p>
      </DocHeader>

      <section className="mk-doc-body">
        <ol className="mk-install-steps">
          <li>
            Open a new tab and go to <CopyField value="chrome://extensions" />
          </li>
          <li>Turn on <strong>Developer mode</strong> (top-right corner).</li>
          <li>Click <strong>Load unpacked</strong> and select this folder: <CopyField value={EXTENSION_DIR} /></li>
          <li>Pin Token Footprint from the puzzle-piece menu, then open ChatGPT, Claude, or Gemini.</li>
        </ol>
        <p>
          After you change the code, click the reload icon on the extension&apos;s card
          in <code>chrome://extensions</code> to pick up the new version.
        </p>
      </section>
    </MarketingPage>
  )
